...
public class give_introduction : MonoBehaviour
{
    ...
    public void introduce_the_app()
    {
        ...
        io_setup.PlayTextToSpeech("If you already know the direction, say: 'Start!' and begin walking. If there's an object in your way, you'll hear a beep from the direction of the obstacle. To end the obstacle avoidance, say : 'End!'");
        io_setup.PlayTextToSpeech("Need to know the time? Just ask: 'What's the time?' Want to change the voice or adjust other settings? Say: 'Configure!'");
