...
public class give_introduction : MonoBehaviour
{
    ...
    public async void introduce_the_app()
    {
        ...
        await io_setup.PlayTextToSpeech("If you already know the direction, say: 'Start!' and begin walking. You have to look down at a 45 degree angle and follow the sound. To end the obstacle avoidance, say : 'End!'");
